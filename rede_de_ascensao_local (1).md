...
## 7.1 Participante em ascensão

Pessoa em vulnerabilidade, transição produtiva ou busca de primeira oportunidade.
...
3. Classificar risco.
4. Suspender atividade quando necessário.
5. Acionar Estado ou órgão competente em caso grave.
6. Registrar decisão.
7. Corrigir falha.
...
- contratação fora da zona de coerção;
- apoio jurídico;
...
1. A comunidade orienta a demanda, mas não comanda trabalho informal.
2. Nenhuma ajuda autoriza abuso.
...
plano_de_missao:
  ...
  gera_beneficio_economico_para_terceiro: false
  exige_formalizacao: false
  fonte_de_recurso: ""
  evidencia_passaporte: []
...
- demanda pagável identificada;
- substituição de serviço público ou privado;
...
## Atividades que não devem continuar como extensão
-
